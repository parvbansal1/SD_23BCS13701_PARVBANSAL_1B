  ...
  return (
    <div className="min-h-screen bg-[#FAF8F5] flex">
      <div className="hidden lg:block lg:w-1/2 relative">
        <img src="https://images.unsplash.com/photo-1542314831-c53cd4b85ca4?auto=format&fit=crop&q=80&w=1200" alt="Luxury" className="absolute inset-0 w-full h-full object-cover grayscale-[20%]" />
      </div>
      <div className="w-full lg:w-1/2 flex flex-col justify-center px-8 sm:px-16 py-12">
        <div className="max-w-md w-full mx-auto">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="group">
              <label className="block text-xs uppercase tracking-widest text-[#A8A29E] mb-2">Email Address</label>
            ...
            <button type="submit" className="w-full py-4 mt-8 bg-[#1C1917] text-white text-xs uppercase tracking-widest hover:bg-[#8C3A3A] transition-colors">Sign In</button>
          </form>
          
          <div className="mt-12 text-center text-sm text-[#57534E]">
            Not a member? <Link to="/register" className="text-[#1C1917] border-b border-[#1C1917] hover:text-[#8C3A3A]">Register</Link>
          </div>
        </div>
      </div>
    </div>
